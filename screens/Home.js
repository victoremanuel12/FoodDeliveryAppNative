...
export default function Home({ navigation }) {
  ...
  const initialCurrentLocation = {
    streetName: "Salvador",
    gps: {
      latitude: -12.9722184, //1.5496614931250685,
      longitude: -38.5014136,//110.36381866919922
    }
  }
  ...
  function onSelectCategory(category) {
    // filter the restaurant that sell the category
    let restaurantList = restaurantData.filter(element => element.categories.includes(category.id))
  ...
  function getCategoryNameById(id) {
    let category = categories.filter(element => element.id == id)
    ...
    return (
      <View style={{ flexDirection: 'row', height: 100, marginVertical: 10 }}>
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <View style={{ width: "70%", height: "50%", alignItems: "center", justifyContent: "center", backgroundColor: COLORS.lightGray3, borderRadius: SIZES.radius }}>
      ...
      >
        ...
        <View style={{ marginTop: SIZES.padding, flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: "row", marginLeft: 10 }}>
            ...
            {item.categories.map((categoryId) => {
              return (
                <View style={{ flexDirection: 'row' }} key={categoryId}>
                  ...
                  <Text style={{ ...FONTS.h3, color: COLORS.darkgray, marginHorizontal: 2 }}>.</Text>
            ...
            {/* Price */}
            {
              priceRatingArray.map(priceRating => (
  ...
  // ***************************************************************Return of principal function HOME
